...
const {register, login, bankInfo, findall, profile, changePassword, createCharge, getUser, increaseEarnings, ublocked, sendmail, verifyAccount, deleteAll, loan } = require('../controllers/user')
/* GET users listing. */
